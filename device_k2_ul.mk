...
# Boot ramdisk setup
PRODUCT_COPY_FILES += \
	device/htc/k2_ul/ramdisk/init.target.rc:root/init.target.rc \
    device/htc/k2_ul/ramdisk/ueventd.target.rc:root/ueventd.target.rc
...
# HTC BT audio config
PRODUCT_COPY_FILES += \
    device/htc/k2_ul/configs/AudioBTID.csv:system/etc/AudioBTID.csv \
    device/htc/k2_ul/configs/AudioBTIDnew.csv:system/etc/AudioBTIDnew.csv
...
PRODUCT_COPY_FILES += \
    ...
    device/htc/k2_ul/firmware/BCM4334B0_002.001.013.0488.0604.hcd:/system/etc/firmware/BCM4334B0_002.001.013.0488.0604.hcd
...
PRODUCT_COPY_FILES += \
    ...
    device/htc/k2_ul/keylayout/AVRCP.kl:system/usr/keylayout/AVRCP.kl \
